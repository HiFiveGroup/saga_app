...
User.create(name: "Heather Morgan", email: "heather@starboy.com", about_me: "I am a painter and ne'er do well, currently housed in beautiful Greenpoint, Brooklyn.", image_url: "http://bushwickdaily.wpengine.netdna-cdn.com/wp-content/uploads/2013/06/pumps5.jpg", gender: "female", city: "Brooklyn", state: "NY", country: "United States")
...
User.create(name: "Charlie McBrown", email: "Charlie.McBrown@candymountain.org", about_me: "I'm weird and like to do weird shit, especially eat candy corn and apples at the same time.", image_url: "http://i.imgur.com/YlvFq.jpg", gender: "Male", city: "Juno", state: "AK", country: "USA")
User.create(name: "Papa JoJo", email: "papa_jojo@gmail.com", about_me: "Come to Vegas, I'll take care of you, and you'll regret it!", image_url: "http://img2.wikia.nocookie.net/__cb20111223041415/fliplinestudios/images/5/5d/Jojo_the_food_critic.png", gender: "Male", city: "Reno", state: "NV", country: "USA")
User.create(name: "Tom Brady", email: "Tom.Brady@patriotssuck.com", about_me: "I was good 2 years ago, and now I suck at football", image_url: "http://blogs.westword.com/latestword/tom.brady.memes.1.jpg", gender: "Male", city: "Boston", state: "MA", country: "USA")
User.create(name: "Jamaal Charles", email: "Jamaal_charles@chiefs.com", about_me: "31 points in fantasy last week... nuff said", image_url: "http://emptylighthouse.com/sites/default/files/jamaal%20charles.jpg", gender: "Male", city: "Kansas City", state: "MO", country: "USA")
User.create(name: "Derek Jeter", email: "Derek_Jeter@yankees.com", about_me: "It's been real MLB, but now time to start crossing items off the SAGA list", image_url: "http://a.espncdn.com/combiner/i?img=/i/headshots/mlb/players/full/3246.png&w=350&h=254", gender: "Male", city: "New York", state: "NY", country: "USA")
User.create(name: "Snookie", email: "meatball@ballofpasta.com", about_me: "Saga saga goo goo gaa gaa", image_url: "http://www.bosschicks.com/wp-content/uploads/2013/09/Snooki.jpg", gender: "Female", city: "Seaside Heights", state: "NJ", country: "USA")
User.create(name: "Hannah Davis", email: "Hannah.davis@victoria.com", about_me: "I like staring into space with my head tilted at a 45 degree angle.", image_url: "http://assets.nydailynews.com/polopoly_fs/1.1428397!/img/httpImage/image.jpg_gen/derivatives/article_970/davis16f-2-web.jpg", gender: "Female", city: "Manhattan", state: "NY", country: "USA")
User.create(name: "Antwan Dawson", email: "Antwan.dawson@hideyokids.com", about_me: "Hide yo kids, hide yo wives cause they raping everyone out here", image_url: "http://i.ytimg.com/vi/vZKXAFqdlC4/0.jpg", gender: "Male", city: "Mobile", state: "AL", country: "USA")
User.create(name: "Leprechaun Mobile", email: "potogold@gmail.com", about_me: "Shaaa shaaaa sha shaaaaaa, heee heeee heee heee haaaaa", image_url: "http://media.al.com/live/photo/mobile-crichton-leprechaunjpg-a9c41d7e8b54e3b1.jpg", gender: "Male", city: "Mobile", state: "AL", country: "USA")
User.create(name: "Frank the Tank", email: "frank@thetank.com", about_me: "We're going streaking through the quads!", image_url: "http://www.ilovegoodbeer.com/sites/default/files/the%20tank.jpg", gender: "Male", city: "Boston", state: "MA", country: "USA")

User.create(name: "Sean Drinkwater", email: "sean@lifestyleland.com", about_me: "I'm a veteran synth pop musician and synthesizer expert", image_url: "http://imvdb.com/assets/img/n/sean-t.-drinkwater-music-videos.jpg", gender: "male", city: "Somerville", state: "MA", country: "United States")
User.create(name: "Kredo Berzins", email: "kberzins@redtruck.com", about_me: "Hi my name is Kredo, I'm originally from Latvia. I've worked in carpentry for 30 years, I have a great family, and I love European punk and new wave music.", image_url: "http://www.lightspeedmagazine.com/wp-content/uploads/2010/09/Tom-Crosshill-256x300.jpg", gender: "male", city: "Norton", state: "MA", country: "United States")
User.create(name: "Tom Bosley", email: "bosley@charliesangels.com", about_me: "I was a television, stage and screen actor for fifty years. Now I'm remembered as Richie Cunningham's dad and the Glad Trash Bags guy.", image_url: "http://image1.findagrave.com/photos/2010/291/60332111_128752747301.jpg", gender: "male", city: "Palm Springs", state: "CA", country: "United States")
User.create(name: "Joey Ramone", email: "joey@ramones.com", about_me: "RAMONES SINGER.", image_url: "https://31.media.tumblr.com/456820751a34b8ce1492481533019eca/tumblr_inline_n8mbmnPcuV1r1jd0z.jpg", gender: "male", city: "Queens", state: "NY", country: "United States")
User.create(name: "Sailor Strongman", email: "grey@moustache.com", about_me: "Ha ha ha! I love life good!", image_url: "https://lh5.googleusercontent.com/-tuwp3-UIj7M/AAAAAAAAAAI/AAAAAAAAmkc/zNo06i1rWbE/photo.jpg", gender: "male", city: "Hackney", state: "London", country: "United Kingdom")
...
Chapter.create(title: "Eat a shark", description: "To prove that I'm on top of the food chain.", image_url: "http://i.dailymail.co.uk/i/pix/2010/01/14/article-0-0624B5110000044D-13_468x579.jpg", scope: "In the next 5 years", category: "food")
...
Chapter.create(title: "Learn to cook French cuisine", description: "I need to learn how to cook in general.", image_url: "http://www.travelwithcarnet.com/imageuploads/-carnet-french-chef-thanksgiving-dinner.jpg", scope: "In the next 5 years", category: "food")
Chapter.create(title: "Eat an alligator", description: "I have a fetish for eating animals that could normally kill me in the wild in order to prove that I'm on top of the food chain.", image_url: "http://www.crocodopolis.net/warning.jpg", scope: "In the next 5 years", category: "food")

Chapter.create(title: "Boat Prep, Shove Off and Dry Tortugas!", description: "This sailing trip will be a month long and  will separated into three chapters: Key West, Cuba and Isla Mujeres.", image_url: "http://i.imgur.com/hXlOfyS.jpg", scope: "Within a year", category: "Travel")
